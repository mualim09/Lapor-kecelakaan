				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					<div class="header-top-menu">
						<ul class="nav navbar-nav notika-top-nav">
							...
							<li class="nav-item">
								<a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle" style="margin: 0; padding; 0;">
									<img src="<?= (empty($user_foto)) ? base_url() . '/img/noimg.png' : base_url() . '/img/personel/' . $user_foto; ?>" alt="Foto <?= $user_pangkat; ?> <?= $user_nama_lengkap; ?> - NRP. <?= $user_nrp; ?>" style="width: 30px; height: 30px; object-position: center; object-fit: cover; border-radius: 50%;" />
								</a>
