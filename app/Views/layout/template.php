...
<head>
	...
	<!-- Compressed Styles -->
	<link href="<?= base_url(); ?>/landing-temp/css/slides.min.css" rel="stylesheet" type="text/css">
	...
	<!-- Compressed Scripts -->
	<script src="<?= base_url(); ?>/landing-temp/js/slides.min.js" type="text/javascript"></script>

	<!-- Custom Scripts -->
	<!-- <script src="<?= base_url(); ?>/landing-temp/js/custom.js" type="text/javascript"></script> -->
...
<body class="slides horizontal simplifiedMobile animated">
	...
	<nav class="panel top">
		<div class="sections desktop">
			...
			<div class="right">
				<a class="button blue gradient" href="#">Pelapor</a>
				<a class="button green gradient" href="#">Personil</a>
			</div>
		</div>
	...
	<nav class="panel bottom forceMobileView">
		<div class="sections desktop">
			<div class="left">
				<a href="#" class="opacity-8">Available
